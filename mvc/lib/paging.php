<?php class Paging{
  ...
  {
    $htmltext.='<li class="page-item"><a class="page-link" href="'.BASE_URL.$this->basepath.$this->limit.'/0'.'">First</a></li>';
    $htmltext.='<li class="page-item"><a class="page-link" href="'.BASE_URL.$this->basepath.$this->limit.'/'.($this->currentPage-2)*$this->limit.'">Previous</a></li>';
  }
...
if($i==$this->currentPage)
    ...
    //Xuat next, last
        ...
        {
            $htmltext.='<li class="page-item"><a class="page-link" href="'.BASE_URL.$this->basepath.$this->limit.'/'.$this->currentPage*$this->limit.'">Next</a></li>';
    $htmltext.='<li class="page-item"><a class="page-link" href="'.BASE_URL.$this->basepath.$this->limit.'/'.($this->totalPages-1)*$this->limit.'">Last</a></li>';
        }
  $htmltext.='</ul>';
$htmltext.='</nav>';
echo $htmltext;
