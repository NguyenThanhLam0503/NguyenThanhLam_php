...
<table class="table">
  ...
  foreach($products as $p){?>
    <tr>
      ...
      <td><a href='<?php echo BASE_URL?>adminproduct/productDelete/<?php echo $p["productId"]?>'onclick='return confirm("Bạn có chắc muốn xóa Sản Phẩm này vĩnh viễn không?")'>Xóa Vĩnh Viễn</a>|<a href='<?php echo BASE_URL?>adminproduct/productToggleTrash/<?php echo $p['productId']?>'>Khôi Phục Sản Phẩm</a></td>
    </tr>
<?php }?>
  </tbody>
</table>
