...
<table class="table">
  ...
  foreach($products as $p){?>
    <tr>
      ...
      <td><a href='<?php echo BASE_URL?>adminproduct/productToggleTrash/<?php echo $p["productId"]?>'onclick='return confirm("Ban co chac muon xoa sp nay?")'>Xóa</a>|<a href='<?php echo BASE_URL?>adminproduct/updateproduct/<?php echo $p['productId']?>'>Sửa</a></td>
    </tr>
<?php }?>
  </tbody>
</table>
